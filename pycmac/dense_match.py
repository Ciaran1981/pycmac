...
def pims(folder, mode='BigMac', ext="JPG", orientation="Ground_UTM",  
    ...
    mask: bool or string
                 ...
                 True to use QT mask making tool, 
                 Ogr polygon path or resue
                 'reuse' to use a previously QT defined one
    ...
    elif mask != True and mask !=None:
        pims_mask(mask, folder)
        cmd.append("Masq3D=AperiCloud_Ground_UTM_polyg3d.xml")
        print('using GIS poly as mask')
    elif mask == 'reuse':
        cmd.append("Masq3D=AperiCloud_Ground_UTM_polyg3d.xml")
